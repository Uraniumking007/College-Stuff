...
% Title - Font size 16
{\fontsize{16}{19}\selectfont \textbf{Practical No.7}}\\[0.5cm]

% Aim - Font size 14
{\fontsize{14}{17}\selectfont \textbf{Aim:}}\\[0.3cm]

% Paragraph - Font size 12, justified
{\fontsize{12}{14}\selectfont
To write a TypeScript program to demonstrate different methods to increase file size using Node.js file system operations.
}\\[1cm]

% Code section
{\fontsize{14}{17}\selectfont \textbf{Code:}}\\[0.3cm]
...
% Output section
{\fontsize{14}{17}\selectfont \textbf{Output:}}\\[0.3cm]

\begin{center}
\includegraphics[width=\textwidth]{practical7-output.png}
\end{center}
