...
% Title
\begin{center}
    \Large\textbf{Practical No.9}
\end{center}

% Aim
\section*{Aim}
\large\textbf{To implement Hill Cipher and analyze its security.}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{practical9-output.png}
    \caption{Output of Hill Cipher Implementation}
\end{figure}
