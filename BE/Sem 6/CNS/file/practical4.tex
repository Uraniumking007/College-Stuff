...
% Font sizes
\newcommand{\headingfont}{\fontsize{16}{18}\bfseries}
\newcommand{\subheadingfont}{\fontsize{14}{16}\bfseries}
\newcommand{\textfont}{\fontsize{12}{14}\selectfont}
...
\lstdefinelanguage{JavaScript}{
  keywords={typeof, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break, const, let, class, extends, private, public, this, super, constructor, static, get, set, for, of, interface, type, import, export, from, default, async, await},
...
\section*{Practical No.4}
\textfont

\subsection*{Aim}
To implement and compare two Pseudo-Random Number Generator (PRNG) algorithms: Linear Congruential Generator (LCG) and Blum Blum Shub (BBS) Generator. Additionally, perform statistical tests including uniformity test (Chi-Square test), scalability test (performance analysis), and consistency test (statistical analysis) to evaluate the quality and performance of the generated random numbers.
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{practical4-output.png}
  \caption{Output of Random Number Generation and Testing Program}
\end{figure}
