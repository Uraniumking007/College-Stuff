...
\begin{center}
\Large\textbf{Practical No.2}
\end{center}

\vspace{0.5cm}

\noindent\textbf{Aim:} Implement Monoalphabetic Cipher encryption and decryption
...
\begin{center}
\includegraphics[width=\textwidth]{practical2-output.png}
\end{center}
