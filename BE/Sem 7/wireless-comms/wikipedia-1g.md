...
== Technology ==
1G introduced the cellular network concept which divided service areas into cells, each served by a low-power transmitter, which enabled frequency reuse and higher capacity.  
