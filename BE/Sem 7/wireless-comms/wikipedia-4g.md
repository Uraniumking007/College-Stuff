...
Source: https://en.wikipedia.org/wiki/4G
...
Woerner, Brian (June 20–22, 2001). "Research Directions for Fourth Generation Wireless" (PDF). Proceedings of the 10th International Workshops on Enabling Technologies: Infrastructure for Collaborative Enterprises (WET ICE 01). 10th International Workshops on Enabling Technologies: Infrastructure for Collaborative Enterprises (WET ICE 01). Massachusetts Institute of Technology, Cambridge, Massachusetts, USA. Archived from the original (PDF) on January 6, 2006. (118kb)
